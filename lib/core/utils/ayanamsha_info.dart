...
class AyanamshaInfoHelper {
  static const List<AyanamshaInfo> _ayanamshaInfo = [
    AyanamshaInfo(
      ...
      regions: ['All India', 'North India', 'South India', 'East India', 'West India'],
    ...
    AyanamshaInfo(
      ...
      regions: ['South India', 'Karnataka', 'Tamil Nadu', 'Kerala', 'Andhra Pradesh'],
    ...
    AyanamshaInfo(
      type: AyanamshaType.faganBradley,
      name: 'Fagan-Bradley Ayanamsha',
      description: 'Western sidereal ayanamsha, used in Western sidereal astrology',
    ...
    AyanamshaInfo(
      ...
      description: 'Based on Sri Yukteshwar\'s calculations, used by some traditional schools',
    ...
    AyanamshaInfo(
      type: AyanamshaType.jnBhasin,
      name: 'J.N. Bhasin Ayanamsha',
      description: 'Developed by J.N. Bhasin, used in some North Indian traditions',
    ...
    AyanamshaInfo(
      type: AyanamshaType.babylonian,
      name: 'Babylonian Ayanamsha',
      description: 'Ancient Babylonian ayanamsha, used in historical calculations',
    ...
    AyanamshaInfo(
      type: AyanamshaType.aldebaran15Tau,
    ...
    AyanamshaInfo(
      type: AyanamshaType.galacticCenter,
      name: 'Galactic Center Ayanamsha',
      description: 'Based on the Galactic Center, used in modern astrological research',
  ...
  static AyanamshaInfo? getAyanamshaInfo(AyanamshaType type) {
    try {
      return _ayanamshaInfo.firstWhere((info) => info.type == type);
    } catch (e) {
      return null;
    }
  }
