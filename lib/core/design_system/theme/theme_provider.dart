...
class ThemeNotifier extends AsyncNotifier<ThemeState> {
  ...
  Future<ThemeState> _loadThemeFromStorage() async {
    try {
      ...
      return ThemeState(
          ...
          isDarkMode: _getIsDarkMode(AppThemeMode.system));
    }
  }
  ...
  Future<void> refreshSystemTheme() async {
    ...
    if (currentState.mode == AppThemeMode.system) {
      ...
      final newState =
          ThemeState(mode: AppThemeMode.system, isDarkMode: isDarkMode);
      state = AsyncValue.data(newState);
    }
  }
}
  ...
  return themeState.when(
    data: (state) => {
      ...
      'backgroundColor': state.isDarkMode
          ? TraditionalTheme.backgroundDark
          : TraditionalTheme.backgroundLight,
      'surfaceColor': state.isDarkMode
          ? TraditionalTheme.surfaceDark
          : TraditionalTheme.surfaceLight,
      'surfaceVariantColor': state.isDarkMode
          ? TraditionalTheme.surfaceVariantDark
          : TraditionalTheme.surfaceVariantLight,
      'cardColor': state.isDarkMode
          ? TraditionalTheme.surfaceDark
          : TraditionalTheme.surfaceLight,
      'primaryTextColor': state.isDarkMode
          ? TraditionalTheme.textDark
          : TraditionalTheme.textLight,
      'secondaryTextColor': state.isDarkMode
          ? TraditionalTheme.textSecondaryDark
          : TraditionalTheme.textSecondaryLight,
      'tertiaryTextColor': state.isDarkMode
          ? TraditionalTheme.textTertiaryDark
          : TraditionalTheme.textTertiaryLight,
      'hintTextColor': state.isDarkMode
          ? TraditionalTheme.textTertiaryDark
          : TraditionalTheme.textTertiaryLight,
      'borderColor': state.isDarkMode
          ? TraditionalTheme.borderDark
          : TraditionalTheme.borderLight,
      'dividerColor': state.isDarkMode
          ? TraditionalTheme.dividerDark
          : TraditionalTheme.dividerLight,
      'shadowColor': state.isDarkMode ? Colors.black54 : Colors.black12,
      'primaryColor': state.isDarkMode
          ? TraditionalTheme.accentSaffronDark
          : TraditionalTheme.primarySaffron,
      'secondaryColor': state.isDarkMode
          ? TraditionalTheme.accentGoldDark
          : TraditionalTheme.primaryGold,
      'errorColor': state.isDarkMode
          ? TraditionalTheme.accentRedDark
          : TraditionalTheme.primaryRed,

      // Gradients
      'primaryGradient': state.isDarkMode
          ? TraditionalTheme.primaryGradientDark
          : TraditionalTheme.primaryGradient,
      'secondaryGradient': state.isDarkMode
          ? TraditionalTheme.secondaryGradientDark
          : TraditionalTheme.secondaryGradient,
      'accentGradient': state.isDarkMode
          ? TraditionalTheme.accentGradientDark
          : TraditionalTheme.accentGradient,
    ...
    loading: () {
      ...
      return {
        'backgroundColor': isSystemDark
            ? TraditionalTheme.backgroundDark
            : TraditionalTheme.backgroundLight,
        'surfaceColor': isSystemDark
            ? TraditionalTheme.surfaceDark
            : TraditionalTheme.surfaceLight,
        'surfaceVariantColor': isSystemDark
            ? TraditionalTheme.surfaceVariantDark
            : TraditionalTheme.surfaceVariantLight,
        'cardColor': isSystemDark
            ? TraditionalTheme.surfaceDark
            : TraditionalTheme.surfaceLight,
        'primaryTextColor': isSystemDark
            ? TraditionalTheme.textDark
            : TraditionalTheme.textLight,
        'secondaryTextColor': isSystemDark
            ? TraditionalTheme.textSecondaryDark
            : TraditionalTheme.textSecondaryLight,
        'tertiaryTextColor': isSystemDark
            ? TraditionalTheme.textTertiaryDark
            : TraditionalTheme.textTertiaryLight,
        'hintTextColor': isSystemDark
            ? TraditionalTheme.textTertiaryDark
            : TraditionalTheme.textTertiaryLight,
        'borderColor': isSystemDark
            ? TraditionalTheme.borderDark
            : TraditionalTheme.borderLight,
        'dividerColor': isSystemDark
            ? TraditionalTheme.dividerDark
            : TraditionalTheme.dividerLight,
        'shadowColor': isSystemDark ? Colors.black54 : Colors.black12,
        'primaryColor': isSystemDark
            ? TraditionalTheme.accentSaffronDark
            : TraditionalTheme.primarySaffron,
        'secondaryColor': isSystemDark
            ? TraditionalTheme.accentGoldDark
            : TraditionalTheme.primaryGold,
        'errorColor': isSystemDark
            ? TraditionalTheme.accentRedDark
            : TraditionalTheme.primaryRed,
