...
/// following traditional aesthetics and colors
library;
...
class TraditionalTheme {
  // Traditional Color Palette - Light Theme
  ...
  static const Color primaryRed =
      Color(0xFFB71C1C); // Deep red for better contrast
  static const Color primaryGold =
      Color(0xFFD84315); // Much darker gold for AA compliance (4.5:1+)
  static const Color primaryMaroon =
      Color(0xFF4A148C); // Deep maroon for better contrast
  static const Color primaryOrange =
      Color(0xFFE65100); // Deep orange for better contrast
  static const Color primaryCream =
      Color(0xFFFFFBF0); // Warmer cream background
  static const Color primaryBrown =
      Color(0xFF5D4037); // Rich brown for better contrast
  static const Color primaryYellow =
      Color(0xFFF9A825); // Rich yellow for better contrast

  // Secondary Colors - Light Theme
  static const Color secondaryBlue =
      Color(0xFF1565C0); // Deep blue for better contrast
  static const Color secondaryGreen =
      Color(0xFF2E7D32); // Deep green for better contrast
  static const Color secondaryPurple =
      Color(0xFF6A1B9A); // Deep purple for better contrast
  static const Color secondaryTeal =
      Color(0xFF00695C); // Deep teal for better contrast

  // Light Theme Colors
  static const Color backgroundLight =
      Color(0xFFFFFBF0); // Warm cream background
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white surface
  static const Color surfaceVariantLight =
      Color(0xFFFFF8E1); // Light cream variant
  static const Color textLight =
      Color(0xFF1B1B1B); // Near black for maximum contrast
  static const Color textSecondaryLight =
      Color(0xFF424242); // Dark gray for secondary text
  static const Color textTertiaryLight =
      Color(0xFF616161); // Medium gray for tertiary text
  ...
  static const Color surfaceVariantDark =
      Color(0xFF2C2C2C); // Dark surface variant
  ...
  static const Color textTertiaryDark =
      Color(0xFF8A8A8A); // Medium gray for tertiary text
  ...
  static const Color accentSaffronDark =
      Color(0xFFFF8A65); // Lighter saffron for dark theme
  static const Color accentGoldDark =
      Color(0xFFFFB74D); // Lighter gold for dark theme
  static const Color accentRedDark =
      Color(0xFFEF5350); // Lighter red for dark theme

  // Backward compatibility properties
  static const Color textSecondary =
      textSecondaryLight; // For backward compatibility
