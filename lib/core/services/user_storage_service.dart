...
class UserStorageService {
  ...
  Future<Result<void>> saveUser(UserModel user) async {
    try {
      ...
      LoggingHelper.logError('Failed to save user data', source: 'UserStorageService', error: e);
      return ResultHelper.failure(
  ...
  Future<Result<UserModel?>> getCurrentUser() async {
    try {
      ...
      LoggingHelper.logError('Failed to get current user', source: 'UserStorageService', error: e);
      return ResultHelper.failure(
        UnexpectedFailure(message: 'Failed to get current user: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Result<void>> updateUser(UserModel user) async {
    try {
      ...
      LoggingHelper.logError('Failed to update user data', source: 'UserStorageService', error: e);
      return ResultHelper.failure(
        UnexpectedFailure(message: 'Failed to update user data: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Result<void>> deleteUser() async {
    try {
      ...
      LoggingHelper.logError('Failed to delete user data', source: 'UserStorageService', error: e);
      return ResultHelper.failure(
        UnexpectedFailure(message: 'Failed to delete user data: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Result<void>> clearAllUserData() async {
    try {
      ...
      LoggingHelper.logError('Failed to clear user data', source: 'UserStorageService', error: e);
      return ResultHelper.failure(
        UnexpectedFailure(message: 'Failed to clear user data: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Result<Map<String, dynamic>?>> getUserAstrologyData() async {
    try {
      ...
      LoggingHelper.logError('Failed to get user astrology data',
          source: 'UserStorageService', error: e);
      return ResultHelper.failure(
        UnexpectedFailure(message: 'Failed to get user astrology data: ${e.toString()}'),
      );
    }
  }
  ...
  Future<Map<String, dynamic>> getStorageStats() async {
    try {
      ...
      LoggingHelper.logError('Failed to get storage stats', source: 'UserStorageService', error: e);
      return {
        'error': e.toString(),
      };
    }
