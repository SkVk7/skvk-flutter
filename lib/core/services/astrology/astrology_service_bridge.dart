  ...
  Future<Map<String, dynamic>> calculateCompatibility({
    ...
    try {
      ...
      final response = await _apiService.calculateCompatibility(
        groomDateOfBirth:
            utcPerson1BirthDateTime.toIso8601String().split('T')[0],
        groomTimeOfBirth: utcPerson1BirthDateTime
            .toIso8601String()
            .split('T')[1]
            .split('.')[0],
        ...
        brideDateOfBirth:
            utcPerson2BirthDateTime.toIso8601String().split('T')[0],
        brideTimeOfBirth: utcPerson2BirthDateTime
            .toIso8601String()
            .split('T')[1]
            .split('.')[0],
  ...
  Map<String, dynamic> _convertCompatibilityResponseToLocal(
    ...
    if (converted.containsKey('groomBirthData')) {
      ...
      if (groomBirthData != null) {
        converted['groomBirthData'] =
            _convertResponseToLocal(groomBirthData, groomTimezoneId);
      }
    }
    ...
    if (converted.containsKey('brideBirthData')) {
      ...
      if (brideBirthData != null) {
        converted['brideBirthData'] =
            _convertResponseToLocal(brideBirthData, brideTimezoneId);
      }
    }
