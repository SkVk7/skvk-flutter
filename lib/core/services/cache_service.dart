...
class CacheType {
  static const String userBirthData = 'user_birth_data'; // Full birth chart - cached for years
  static const String minimalBirthData = 'minimal_birth_data'; // For compatibility - 30 days, limited entries
  static const String compatibility = 'compatibility'; // Compatibility results - 30 days, limited entries
...
class CacheService {
  ...
  // Cache thresholds
  static const int maxMinimalBirthDataEntries = 20; // Max cached groom/bride combinations
  static const int maxCompatibilityEntries = 30; // Max cached compatibility results
