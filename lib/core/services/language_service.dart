...
class LanguagePreferences {
  ...
  @override
  String toString() => 'LanguagePreferences(header: $headerLanguage, content: $contentLanguage)';
}
...
class LanguageService extends Notifier<LanguagePreferences> {
  ...
  Future<void> _loadPreferences() async {
    try {
      ...
      final headerIndex = prefs.getInt(_headerLanguageKey) ?? SupportedLanguage.english.index;
      final contentIndex = prefs.getInt(_contentLanguageKey) ?? SupportedLanguage.english.index;
...
final languageServiceProvider = NotifierProvider<LanguageService, LanguagePreferences>(() {
