...
class ReusablePrimaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: height ?? ResponsiveSystem.spacing(context, baseSpacing: 56),
                    ...
                    children: [
                      if (icon != null) ...[
                        Icon(
                          icon,
                          size:
                              ResponsiveSystem.iconSize(context, baseSize: 16),
                          color: isEnabled
                              ? effectiveTextColor
                              : effectiveTextColor.withValues(alpha: 0.3),
                        ),
                        ResponsiveSystem.sizedBox(context,
  ...
  Widget build(BuildContext context) {
    ...
    Widget fab = FloatingActionButton(
      ...
      foregroundColor: isEnabled
          ...
          : effectiveForegroundColor.withValues(alpha: 0.3),
      child: Icon(
        icon,
