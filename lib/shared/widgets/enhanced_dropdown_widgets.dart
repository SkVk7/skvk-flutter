/// Enhanced Dropdown Widgets
///
/// Reusable widgets for creating rich dropdown items with descriptions,
...
/// Enhanced dropdown item widget
class EnhancedDropdownItem<T> extends StatelessWidget {
  final T value;
...
/// Enhanced list tile for selection dialogs
class EnhancedListTile<T> extends StatelessWidget {
  final T value;
  final DropdownItemInfo info;
...
/// Enhanced current selection display widget
class EnhancedCurrentSelection<T> extends StatelessWidget {
  final T value;
  final DropdownItemInfo info;
  final Color primaryColor;
  final Color primaryTextColor;
  ...
  const EnhancedCurrentSelection({
    super.key,
    required this.value,
    required this.info,
    required this.primaryColor,
...
/// Utility class for building enhanced dropdowns
class EnhancedDropdownBuilder {
  ...
  static Widget buildCurrentSelection<T>({
    ...
    final info = getInfo(value);
    return EnhancedCurrentSelection<T>(
      value: value,
      info: info,
      primaryColor: primaryColor,
      primaryTextColor: primaryTextColor,
