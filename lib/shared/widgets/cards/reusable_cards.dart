...
class ReusableInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textColor = ThemeProperties.getPrimaryTextColor(context);
    final shadowColor = ThemeProperties.getShadowColor(context);
    ...
    Widget card = Container(
      ...
      child: Padding(
        padding: padding ?? ResponsiveSystem.all(context, baseSpacing: 20),
        child: Column(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            offset:
                Offset(0, ResponsiveSystem.spacing(context, baseSpacing: 6)),
          ),
        ],
      ),
      child: Padding(
