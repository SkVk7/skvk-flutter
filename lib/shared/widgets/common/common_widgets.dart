    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          padding: padding ??
              ResponsiveSystem.symmetric(context, horizontal: 24, vertical: 16),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: ResponsiveSystem.symmetric(context,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: onTap,
        contentPadding:
            ResponsiveSystem.symmetric(context, horizontal: 16, vertical: 8),
      ),
    );
  }
}
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius:
                    ResponsiveSystem.circular(context, baseRadius: 10),
              ),
    ...
    return Row(
      children: [
        ...
        Switch(
          ...
          inactiveThumbColor:
              inactiveColor ?? ThemeProperties.getSurfaceColor(context),
        ),
      ],
    );
  }
