...
import '../buttons/reusable_buttons.dart';
import '../forms/reusable_form_fields.dart';
import '../cards/reusable_cards.dart';

/// Centralized widgets that use reactive sizing and themed coloring
class CentralizedWidgets {
  static CentralizedWidgets get instance =>
      _instance ??= CentralizedWidgets._();
...
class CentralizedInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ReusableInfoCard(
      title:
          '', // CentralizedInfoCard doesn't have title, but ReusableInfoCard requires it
...
class CentralizedLocationSuggestionItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        padding:
            ResponsiveSystem.symmetric(context, horizontal: 16, vertical: 12),
        child: Row(
          children: [
            Icon(
              Icons.location_on,
...
class CentralizedGradientAppBar extends StatelessWidget
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: ThemeProperties.getSecondaryTextColor(context),
                    height:
                        ResponsiveSystem.lineHeight(context, baseHeight: 1.5),
                  ),
                ),
              ],
            ),
...
class CentralizedProfilePhotoWithHover extends StatefulWidget {
  ...
  @override
  State<CentralizedProfilePhotoWithHover> createState() =>
      _CentralizedProfilePhotoWithHoverState();
}

class _CentralizedProfilePhotoWithHoverState
    extends State<CentralizedProfilePhotoWithHover>
...
class CentralizedFadeAnimation extends StatefulWidget {
  ...
  @override
  State<CentralizedFadeAnimation> createState() =>
      _CentralizedFadeAnimationState();
}
...
class CentralizedSlideAnimation extends StatefulWidget {
  ...
  @override
  State<CentralizedSlideAnimation> createState() =>
      _CentralizedSlideAnimationState();
}
...
class CentralizedStaggerAnimation extends StatefulWidget {
  ...
  @override
  State<CentralizedStaggerAnimation> createState() =>
      _CentralizedStaggerAnimationState();
}

class _CentralizedStaggerAnimationState
    extends State<CentralizedStaggerAnimation>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
...
class CentralizedAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      elevation:
          ResponsiveSystem.elevation(context, baseElevation: elevation ?? 4),
...
class CentralizedThemeDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<String>(
      ...
      icon: Container(
        padding:
            EdgeInsets.all(ResponsiveSystem.spacing(context, baseSpacing: 4)),
        decoration: BoxDecoration(
          color: ThemeProperties.getAppBarTextColor(context)
              .withValues(alpha: 0.1),
