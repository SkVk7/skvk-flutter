          ...
          builder: (context, constraints) {
            return Column(
              ...
              children: [
                ...
                SizedBox(
                  width: ResponsiveSystem.iconSize(context, baseSize: iconSize ?? 31.92),
                  height: ResponsiveSystem.iconSize(context, baseSize: iconSize ?? 31.92),
                  child: Icon(
                    icon,
                  ...
                  constraints: BoxConstraints(
                    maxHeight: constraints.maxHeight > 0
                        ? constraints.maxHeight - 
                          ResponsiveSystem.iconSize(context, baseSize: iconSize ?? 31.92) - 
