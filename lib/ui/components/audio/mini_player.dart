...
import 'package:skvk_application/main.dart' show navigatorKey;
...
class MiniPlayer extends ConsumerWidget {
                ...
                Flexible(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      unawaited(_expandToNowPlaying(navigatorContext, ref));
                    },
  ...
  Future<void> _expandToNowPlaying(BuildContext context, WidgetRef ref) async {
    unawaited(
      LoggingHelper.logDebug(
...
class _CustomProgressBarState extends State<_CustomProgressBar> {
  ...
  Widget build(BuildContext context) {
    final currentValue =
        _isDragging && _dragValue != null ? _dragValue! : widget.value;
