...
class _PradakshanaScreenState extends ConsumerState<PradakshanaScreen>
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius:
                      ResponsiveSystem.circular(context, baseRadius: 2),
                ),
              ),
                        ...
                        builder: (context, innerConstraints) {
                          ...
                          final availableSpace = maxHeight -
                              ResponsiveSystem.spacing(context,
                                  baseSpacing:
                                      200); // Account for other elements
                          ...
                          return Container(
                            constraints: BoxConstraints(
                              ...
                              minHeight: ResponsiveSystem.spacing(context,
                                  baseSpacing: 150),
                            ),
                            height: scrollHeight,
                            padding:
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    contentPadding:
                        ResponsiveSystem.all(context, baseSpacing: 12),
                    hintText: '0',
                    hintStyle: TextStyle(
                      color: ThemeProperties.getSecondaryTextColor(context),
                    ),
  ...
  Widget _buildCrownTimeSelector(double containerHeight) {
    ...
    final padding = ResponsiveSystem.spacing(context, baseSpacing: 16) *
        2; // top and bottom padding
    final labelHeight =
        ResponsiveSystem.spacing(context, baseSpacing: 28); // label and spacing
                ...
                child: Container(
                  ...
                  child: ListWheelScrollView.useDelegate(
                    ...
                    childDelegate: ListWheelChildBuilderDelegate(
                      builder: (context, index) {
                        final isSelected =
                            index == (_cooldownDuration.inMinutes % 60);
                        return Container(
                          alignment: Alignment.center,
                          padding: EdgeInsets.symmetric(
                            vertical: ResponsiveSystem.spacing(context,
          ...
          children: [
            ...
            Expanded(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  minHeight:
                      ResponsiveSystem.spacing(context, baseSpacing: 200),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                ThemeProperties.getPrimaryColor(context).withValues(alpha: 0.2),
                  ...
                  return Transform.scale(
                    ...
                    child: FittedBox(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize:
                              ResponsiveSystem.fontSize(context, baseSize: 72),
                          fontWeight: FontWeight.bold,
              ...
              return Transform.scale(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    constraints: BoxConstraints(
                      minHeight:
                          ResponsiveSystem.spacing(context, baseSpacing: 100),
                      maxHeight:
                          ResponsiveSystem.spacing(context, baseSpacing: 200),
                    ),
                    decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          ...
                          size:
                              ResponsiveSystem.iconSize(context, baseSize: 32),
                        ...
                        if (_isButtonDisabled) ...[
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: ResponsiveSystem.fontSize(context,
                                  baseSize: 12),
                              color: ThemeProperties.getSecondaryTextColor(
                                  context),
                            ),
                            textAlign: TextAlign.center,
                          ),
