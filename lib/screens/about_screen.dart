...
class _AboutScreenState extends ConsumerState<AboutScreen> with TickerProviderStateMixin {
  ...
  Widget _buildAnimatedCard(BuildContext context, int index, {required Widget child}) {
          ...
          child: CustomScrollView(
            slivers: [
              SliverAppBar(
                ...
                elevation: ResponsiveSystem.elevation(context, baseElevation: 0),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      ResponsiveSystem.sizedBox(context, height: 16),
                      _buildAnimatedCard(context, 2, child: _buildTechnicalInfo()),
                      ResponsiveSystem.sizedBox(context, height: 16),
                      _buildAnimatedCard(context, 3, child: _buildAttribution()),
