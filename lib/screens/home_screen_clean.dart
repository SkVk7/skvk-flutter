...
class _HomeScreenState extends ConsumerState<HomeScreen> {
              ...
              slivers: [
                ...
                SliverToBoxAdapter(
                  child: Container(
                    ...
                    child: CentralizedWelcomeSection(
                      title: translationService.translateContent('welcome_title',
                          fallback: 'Welcome to Vedic Astrology Pro'),
                      subtitle: translationService.translateContent('welcome_subtitle',
                          fallback:
                  ...
                  child: CentralizedQuickActionsSection(
                    ...
                    actions: [
                      CentralizedQuickActionCard(
                        title: translationService.translateHeader('todays_guidance',
                            fallback: 'Today\'s Guidance'),
                        icon: Icons.auto_awesome,
                        color: ThemeProperties.getPrimaryColor(context),
                        onTap: () => _navigateWithProfileCheck(
                            context, '/predictions', 'Today\'s Guidance', translationService),
                        isDark: isDark,
                      ),
                      CentralizedQuickActionCard(
                        title: translationService.translateHeader('my_birth_chart',
                            fallback: 'My Birth Chart'),
                        icon: Icons.star,
                        color: ThemeProperties.getSecondaryColor(context),
                        onTap: () => _navigateWithProfileCheck(
                            context, '/horoscope', 'Birth Chart', translationService),
                        isDark: isDark,
                      ),
                    ],
                  ),
                ...
                SliverToBoxAdapter(
                  child: CentralizedFeaturesGridSection(
                    title: translationService.translateHeader('features', fallback: 'Features'),
                    features: [
                      CentralizedFeatureCard(
                        title: translationService.translateHeader('sacred_calendar',
                      ...
                      CentralizedFeatureCard(
                        title: translationService.translateHeader('compatibility_check',
  ...
  void _showFeatureAccessPopup(
      BuildContext context, String featureName, TranslationService translationService) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          title: CentralizedText(
            text: translationService.translateContent('complete_your_profile',
          ...
          content: Column(
            ...
            children: [
              ...
              CentralizedText(
                text: 'To access $featureName, please complete your profile first.',
          ...
          actions: [
            CentralizedModernButton(
              text: translationService.translateContent('cancel', fallback: 'Cancel'),
